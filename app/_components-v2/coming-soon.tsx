      ...
      <div className="h-full flex items-center flex-col justify-center gap-10">
        {!logoInNav && (
          <img
            src="/images/nell.png"
            alt="logo"
            className="entrance-logo top-[80px] z-50  navbar 2xl:w-109  3xl:w-96 md:w-60 w-76 absolute xs:top-[80px] sm:top-[80px] md:top-[8.5rem] 2xl:top-21 3xl:top-48 left-[calc(50%-14px)] -translate-x-1/2"
          />
        )}

        <div className="text-wrapper mt-40 md:mt-60 2xl:mt-60 3xl:top-48">
          <h3 className="gradient-title md:text-[3rem] sm:text-[3rem] xs:text-[2rem] text-[5rem] font-round-bold !font-extrabold uppercase md:leading-[7rem] leading-[4.5rem] text-center bg-gradient-to-r from-pink-400 via-red-400 to-orange-400 bg-clip-text text-transparent">
